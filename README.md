...
### ⚠️ **Note**: this zipped file contains everything needed to carry out a simulation of project execution, any folders containing datasets, extracted features, trained models and others have not been included for the previous reason but can be generated by running the notebooks from the first to the last.
